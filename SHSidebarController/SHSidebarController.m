...
-(void)closeAndPop{
    ...
    if (menuOpened){
    [self.mainVC.view hideOrigamiTransitionWith:self.menuVC.view NumberOfFolds:3 Duration:.3 Direction:XYOrigamiDirectionFromLeft completion:^(BOOL finished) {
...
-(void)close{
    ...
    if (menuOpened){
        ...
        [self.mainVC.view hideOrigamiTransitionWith:self.menuVC.view NumberOfFolds:3 Duration:.4 Direction:XYOrigamiDirectionFromLeft completion:^(BOOL finished) {
...
-(void)open{
    ...
    if (!menuOpened){
        ...
        [self.mainVC.view showOrigamiTransitionWith:self.menuVC.view NumberOfFolds:3 Duration:.4 Direction:XYOrigamiDirectionFromLeft completion:^(BOOL finished) {
